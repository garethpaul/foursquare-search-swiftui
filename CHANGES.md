...
- Merge: PR #20 merged the hosted-green implementation as merge commit
  `e76a351`; this follow-up preserves the completed evidence contract that was
  recorded after that exact implementation head became green.
